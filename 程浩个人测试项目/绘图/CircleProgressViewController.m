...
- (void)viewDidLoad {
    ...
    example1.progressColor = RedColor;
...
//    [example1 layoutIfNeeded];
    ...
    example2.progressColor = GreenColor;
...
//    [examples addObject:example2];
    ...
    THCircularProgressView *example3 = [[THCircularProgressView alloc] initWithCenter:CGPointMake(width/4, height*0.75) radius:radius lineWidth:radius progressMode:THProgressModeDeplete progressColor:BlueColor progressBackgroundMode:THProgressBackgroundModeCircle progressBackgroundColor:[UIColor colorWithRed:0.96f green:0.96f blue:0.96f alpha:1.00f] percentage:percentage];
    example3.clockwise = NO;
//    [self.view addSubview:example3];
//    [examples addObject:example3];
    
    THCircularProgressView *example4 = [[THCircularProgressView alloc] initWithCenter:CGPointMake(width*0.75, height*0.75) radius:radius lineWidth:radius progressMode:THProgressModeFill progressColor:PurpleColor progressBackgroundMode:THProgressBackgroundModeNone progressBackgroundColor:nil percentage:percentage];
    example4.clockwise = NO;
//    [self.view addSubview:example4];
//    [examples addObject:example4];
    
    THCircularProgressView *example5 = [[THCircularProgressView alloc] initWithCenter:CGPointMake(width*0.5, height*0.5) radius:radius lineWidth:10 progressMode:THProgressModeFill progressColor:BlueColor progressBackgroundMode:THProgressBackgroundModeCircumference progressBackgroundColor:GrayColor percentage:percentage];
